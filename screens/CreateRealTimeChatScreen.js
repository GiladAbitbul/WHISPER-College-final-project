...
const CreateRealTimeChat = ({navigation}) => {
...
const handleSuggestionClick = (suggestion) => {
  ...
  useEffect(() => {
    navigation.setOptions({
      ...
      headerStyle: {},
      headerTitleAlign: 'center',
      headerTitle: 'Start a real time chat',
      headerTitle: () => (
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      {member ? (
        ...
        <TouchableOpacity onPress={() => {handleRemoveMember()}}  testID="remove-user-button" style={{borderRadius: 50, borderWidth:1, padding:2}}>
        ...
        <View style={styles.inputElementsContainer}>
          ...
          (
            ...
            emailInput &&
            (
              <TouchableOpacity onPress={() => {handlePlusPress()}} testID="add-user-button" style={{borderRadius: 50, borderWidth:1, padding:2}}>
...
export default CreateRealTimeChat
